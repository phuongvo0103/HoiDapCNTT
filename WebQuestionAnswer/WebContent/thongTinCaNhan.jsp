<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%@page import="form.ThongTinCaNhanForm"%>
...
<div class="w3-top">
  <div class="w3-bar w3-white w3-wide w3-padding-8 w3-card-2">
    ...
    <div class="w3-right w3-hide-small">
      <logic:notEmpty name="thongTinCaNhanForm" property="account">
		<html:link action="/dangxuat" styleClass="w3-bar-item w3-button w3-blue w3-round-large">Đăng xuất</html:link>
		</logic:notEmpty>
		<logic:empty name="thongTinCaNhanForm" property="account">
      ...
      <input class="w3-bar-item" type="text" name="search" placeholder="Search..">
           ...
           <div class="jumbotron">
                <div class="container">
                        ...
                        <li class="active">
                        <html:link action="/danhsachTTCN">Thông tin</html:link>
                        </li>
                        <logic:notEmpty name="thongTinCaNhanForm" property="account">
                        <bean:define id="account" name="thongTinCaNhanForm" property="account"></bean:define>
                        <bean:define id="accountID" name="account" property="accountID"></bean:define>
                        <logic:equal name="thongTinCaNhanForm" property="accountID" value="${accountID}"></logic:equal>
                        <li>
                         <html:link action="/suaTTCN">Chỉnh sửa thông tin</html:link>
                        </li>   
                        </logic:notEmpty>                    
                        </ul>
             </div>
...
<div class="container">
<html:form action="/danhsachTTCN" method="post" enctype="multipart/form-data">
<logic:empty name="thongTinCaNhanForm" property="account">
...
<!-- Hình ảnh thông tin cá nhân -->
  <div class="col-sm-3">                
         <div class="w3-card-12 w3-hover-shadow w3-center" width="800" height="800">
           <bean:define id="a" name="thongTinCaNhanForm" property="account"> </bean:define>
            
			<img alt="alt" src="/WebQuestionAnswer/conmuathitvien.jpg" width="100" height="100">
      ...
      <div class="w3-container">
                <ul class="w3-ul">
    <li><i class="glyphicon glyphicon-bars"></i>Communities</li>
                </ul>
            </div>
  </div>
        ...
        <div class=" form-horizontal col-sm-7  ">
            <div id="section1">
           	...
           	<div class="form-group">
                    ...
                    <div class="col-sm-7 ">
                         <bean:write  name="a" property="displayName" ></bean:write>
                    </div>
                </div>                
                <div class="form-group">
                    <label class="col-sm-3 ">Email:</label>
                    <div class="col-sm-7 ">
                         <bean:write  name="a" property="email" ></bean:write>
                    </div>
                </div>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-7 ">
                         <bean:write  name="a" property="career" ></bean:write>
                    </div>
                </div>
                     <div class="form-group">
                    <label class="col-sm-3 ">Tên công ty:</label>
                    <div class="col-sm-7 ">
                         <bean:write  name="a" property="companyName" ></bean:write>
                    </div>
                </div>
                     <div class="form-group">
                    <label class="col-sm-3 ">Tiểu sử:</label>
                    <div class="col-sm-7 ">
                         <bean:write  name="a" property="aboutMe" ></bean:write>
                    </div>
                </div>		
                 
		<!-- Sửa thông tin cá nhân -->
		
                <html:link action="/suaTTCN">Cập nhật thông tin</html:link>
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <div class="w3-container w3-cell w3-mobile">
                                <h4>
                                <bean:write  name="a" property="totalAnswer" ></bean:write>
                                </h4>
                                <p>answers</p>
                            </div>
                        </div>
                ...
                <div class="form-horizontal col-sm-1">
                    <div class="form-group">
                        <div class="col-sm-12">
                            <div class="w3-container w3-cell w3-mobile">
                                <h4>
                                <bean:write  name="a" property="totalQuestion" ></bean:write>
                                </h4>
                                <p>questions</p>
                            </div>
                        </div>
                ...
                <div class="form-horizontal col-sm-3">
                    <div class="form-group">
                        <div class="col-sm-12">
                            <div class="w3-container w3-cell w3-mobile">
                                <h4>
                                <bean:write name="a" property="reputationPoint" ></bean:write>
                                </h4>
                                <p>ReputationPoint</p>
                            </div>
                        </div>
			...
			<div class="row">
			    ...
			    <div class=" form-horizontal col-sm-5 ">
			               <span class="glyphicon-icon-map-marker"></span>      
			                 <p><bean:write  name="a" property="location" ></bean:write></p>                 
			                <p><bean:write  name="a" property="totalView" ></bean:write> profile views</p>
			                 <p><bean:write  name="a" property="lastSeen" ></bean:write></p>
...
<hr>    
<logic:notEmpty name="thongTinCaNhanForm" property="listQuestion">   
<logic:iterate id="question" name="thongTinCaNhanForm" property="listQuestion">
<div class="row">
